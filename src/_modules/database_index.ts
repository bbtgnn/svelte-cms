...
export const database_index_schema = T.Object({
	...
	projects: T.Union([T.Literal('join'), T.Literal('scabec'), T.Literal('signroom')]),
	work_experiences: T.Union([T.Literal('2019-07_oggi_freelance_docente'), T.Literal('2021-05_oggi_sos'), T.Literal('2022-10_oggi_dyne')])
})
